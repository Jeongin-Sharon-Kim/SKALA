...
const selectedWeather = computed(() => {
  return weatherList.find((weather) => weather.id === route.params.id)
})
...
<template>
  <div class="detail-container">
    <BaseDashboardCard v-if="selectedWeather">
      ...
      <button type="button" class="back-button" @click="goBack">🔙 이전 페이지로 돌아가기</button>
    </BaseDashboardCard>
    ...
    <BaseDashboardCard v-else>
      ...
      <RouterLink class="home-link" to="/"> 날씨 대시보드로 이동 </RouterLink>
    </BaseDashboardCard>
  </div>
</template>
